...
export function PaperRocketIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="-4 70 157 103"
      fill="currentColor"
      aria-hidden="true"
      className={cn('size-[18px] shrink-0 rotate-[8deg]', className)}
    >
      <path
        d="M36.1,160.2 C35.5,158.2 35.0,156.1 35.0,155.6 C35.0,155.1 34.3,153.8 33.3,152.8 C32.4,151.8 31.2,150.0 30.6,148.7 C28.8,145.3 21.2,145.1 16.4,148.4 C14.3,149.8 12.3,150.7 11.8,150.4 C10.6,149.7 10.8,133.2 12.0,132.5 C12.6,132.2 13.0,129.7 13.0,127.0 C13.0,122.7 12.5,121.6 9.5,118.6 C7.6,116.6 6.0,114.3 6.0,113.4 C6.0,112.4 5.2,110.8 4.3,109.8 C1.4,106.6 3.7,104.6 11.3,103.8 C15.0,103.5 19.4,102.7 21.2,102.2 C23.0,101.6 26.5,100.8 29.0,100.5 C31.5,100.1 38.7,98.4 45.0,96.8 C51.3,95.1 57.9,93.6 59.5,93.4 C69.9,92.0 77.8,90.6 87.5,88.5 C93.5,87.2 104.8,84.9 112.5,83.5 C120.2,82.0 130.6,80.0 135.5,79.0 C140.4,78.0 144.7,77.4 145.0,77.7 C145.3,78.0 144.2,79.2 142.5,80.5 C140.8,81.9 138.1,84.1 136.4,85.5 C134.6,86.9 132.7,88.0 132.1,88.0 C131.6,88.0 130.6,88.9 130.1,89.9 C129.5,90.9 126.0,94.2 122.3,97.0 C118.5,99.9 114.2,103.8 112.7,105.7 C111.1,107.5 109.4,109.0 108.8,109.0 C108.2,109.0 104.7,111.5 100.9,114.5 C97.2,117.5 93.8,120.0 93.3,120.0 C92.9,120.0 91.4,121.1 90.0,122.5 C88.6,123.9 83.2,128.8 77.9,133.4 C72.6,138.0 67.3,142.7 66.1,143.9 C64.9,145.1 62.0,146.9 59.7,147.9 C57.4,148.9 53.9,151.3 52.0,153.2 C48.6,156.5 38.6,164.0 37.6,164.0 C37.3,164.0 36.6,162.3 36.1,160.2 Z"
        fillRule="evenodd"
      />
    </svg>
  )
